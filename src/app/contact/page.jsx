const Contacts = () => {
  ...
  {/* the card with the form now */}
          <div className="flex bg-white shadow-lg rounded-lg w-3/4 max-w-5xl">
           
            <div className="bg-[#F3F3F3] w-1/2 p-8 flex flex-col justify-center">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <img src="/images/Icon.png" alt="Location Icon" className="bg-blue-600 rounded-full w-10 h-10 mr-4 p-2" />
                  <div>
                ...
                <div className="flex items-start">
                  <img src="/images/Icon (1).png" alt="Email Icon" className="bg-blue-600 rounded-full w-10 h-10 mr-4 p-2" />
                  <div>
                ...
                <div className="flex items-start">
                  <img src="/images/Icon (2).png" alt="Phone Icon" className="bg-blue-600 rounded-full w-10 h-10 mr-4 p-2" />
                  <div>
              ...
              <form className="space-y-6">
                ...
                <div>
                  <textarea
                    ...
                    className="w-full border text-black border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"
                  ></textarea>
                </div>
